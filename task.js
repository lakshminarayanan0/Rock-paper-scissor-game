...
///start function to make transition between gamescreen and playarea
    ...
    const start=()=>{
        ...
        newgame.addEventListener('click',()=>{
            ...
            document.querySelector('#winner')=winner;
            
            localStorage.remove('playerScore');
            localStorage.remove('computerScore');
...
///by the below function
 ...
 ///of CSS           
    ...
    let time=()=>{
        ...
        playerHand.src=`/rock-paper-scissor webpage/rock-paper-scissor/${option.textContent}.png`;
        console.log(option.textContent);
        computerHand.src=`/rock-paper-scissor webpage/rock-paper-scissor/${computerChoice}.png`;
